  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-5 py-8">
      ...
      <nav className="mt-10 grid grid-cols-2 gap-2 text-sm sm:grid-cols-3">
        {[["/admin/leads", "Tous les leads"], ["/admin/cohortes", "Cohortes"], ["/admin/temoignages", "Témoignages"], ["/admin/parametres/site", "Page d'accueil"], ["/admin/parametres/prix", "Tarifs"], ["/admin/parametres/gabarits", "Gabarits"], ["/admin/parametres/google", "Agenda"]].map(([href, label]) => (
