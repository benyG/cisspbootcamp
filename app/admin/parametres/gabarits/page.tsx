...
const LABELS: Record<string, string> = {
  ...
  followup_after_call_j3: "Relance J+3 après l'appel", unpaid_reminder_j1: "Place non payée, J+1", unpaid_reminder_j3: "Place non payée, J+3", invite_to_book: "Invitation à réserver",
};
